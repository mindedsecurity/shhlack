  ...
  <div id="shhlack_tabs_content" >
     ...
     <div class="shhlack_tabs_content shhlack_hidden" id="shhlack_pairs" >
        <div class="top_margin">
          ...
          <!-- SET AS DEFAULT -->
          <label for="shhlack_default_key_checkbox">Default
          <input type="checkbox" style="width: 10%" id="shhlack_default_key_checkbox">
          </label>
          <div>
            <!-- SELECT KEY -->
            <label class="select small float_left no_right_padding">
              <select id="shhlack_key" class="small no_top_margin">
                ${getPairs()}
              </select>
            </label>
            <!-- INPUT PASSPHRASE -->
            <input type="password" disabled class="small" id="shhlack_value" value="" placeholder="Passphrase here">
            
            <!-- SHOW PASSPHRASE -->
            <span id="shhlack_eye" class="current_status_clear_icon_cover ts_tip ts_tip_top ts_tip_float ts_tip_hidden" aria-labelledby="shhlack_ts_tip_tip_1" style="cursor: pointer" 
            ...
            <!-- DELETE -->
            <span id="shhlack_delete" class="current_status_clear_icon_cover ts_tip ts_tip_top ts_tip_float ts_tip_hidden" aria-labelledby="shhlack_ts_tip_tip_2" style="cursor: pointer" >
              <ts-icon class="ts_icon_trash prefix"></ts-icon>
              <span id="shhlack_ts_tip_tip_2" class="ts_tip_tip">Delete Passphrase</span>
            </span>
            <!-- ADD -->
            <span id="shhlack_add" class="current_status_clear_icon_cover ts_tip ts_tip_top ts_tip_float ts_tip_hidden" aria-labelledby="shhlack_ts_tip_tip_2" style="cursor: pointer" >
         ...
         <div>   
           <!-- ADD --> 
           <div id="shhlack_add_form" style="display: none">
             <!-- INPUT KEY -->
              <input type="text" class="small" id="shhlack_new_key" value="" placeholder="New Key here">
             <!-- INPUT PASSPHRASE -->
              <input type="password" class="small" id="shhlack_new_value" value="" placeholder="Passphrase here">
             <div class="current_status_action_buttons align_right">
              ...
              <button id="shhlack_add_ok" type="button" class="btn btn_small btn_success current_status_save_button">Save</button>
            </div>
           </div>
         </div>
        </div>
